...
public class MarketRatings_deprecated extends Configured implements Tool{
    ...
    static int printUsage(){
        System.out.println("hadoop.experimental_finished.hadoop.experimental_finished.MarketRatings [-m <maps>] [-r <reduces>] <input> <output>");
        return 0;
    }
    ...
    public static void main(String[] args) throws IOException{
        JobConf conf = new JobConf(MarketRatings_deprecated.class);
